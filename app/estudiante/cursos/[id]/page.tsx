...
import { ArrowLeft, FileText, DownloadCloud, BookOpen, AlertCircle } from 'lucide-react';
                      ...
                      {contenido.archivo_url && (
                        <div className="mt-5 p-4 bg-gray-50 rounded-xl border border-gray-200 flex flex-col sm:flex-row sm:items-center justify-between gap-4 transition-colors hover:bg-gray-100">
                          <div className="flex items-center gap-3 overflow-hidden">
                            ...
                            <div>
                              <p className="text-sm font-semibold text-gray-900 truncate pr-4">Material de apoyo</p>
